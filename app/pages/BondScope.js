...
export default class BondScope extends React.Component {
  ...
  static navigationOptions = {
    drawerLabel: 'PT NS BlueScope Indonesia',
      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerMiddle}>
            <Text style={{color:'#fff',fontWeight:'bold'}}>PT NS BLUESCOPE INDONESIA</Text>
          </View>
        </View>

          <View style={styles.merchantBox}>
            <Image style={{width:160,height:90,marginBottom:15}} source={require('../res/blueScope.png')} />
            <Text>
